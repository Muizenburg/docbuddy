...
const Todos = ({ history }) => {
  ...
  const todoForm = () => (
    <form onSubmit={addTodo}>
      <div className="form-group">
        <label className="text-muted">Insert a note!</label>
        <input
  ...
  return (
    <div className="col-md-6 offset-md-3">
      <ToastContainer />
      <h1 className="p-5 text-center">Personal Notes</h1>
      {todoForm()}
      ...
      {loading === true ? (
        ...
        <React.Fragment>
          <h3 className="pt-5 text-center">No notes!</h3>
          <p className="lead text-center">Add a note by completing the form</p>
        </React.Fragment>
      ) : (
